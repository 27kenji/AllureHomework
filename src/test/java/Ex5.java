...
@Epic("Tests for save and compare two articles")
public class Ex5 extends CoreTestCase2 {
    ...
    @DisplayName("Test save and compare two articles")
    @Description("We find two articles and compare them")
    @Step("Starting test testSaveAndCompareTwoArticles")
